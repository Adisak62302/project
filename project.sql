...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2022 at 09:58 AM
...
CREATE TABLE `veg_crop` (
  ...
  `seeds_date` date NOT NULL,
  `fertilize_date` date NOT NULL,
  `soil_date` date NOT NULL,
  `reap_date` date NOT NULL,
  `Total_veg_crop` int(99) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `veg_crop_plot` (
  ...
  `wide_sum` int(11) NOT NULL,
  `long_sum` int(11) NOT NULL,
  `Total_veg_plot` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `vegetable`
  MODIFY `id_Vegetable` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT for table `veg_crop_plot`
--
ALTER TABLE `veg_crop_plot`
  MODIFY `Veg_crop_Plot_id` int(11) NOT NULL AUTO_INCREMENT;
