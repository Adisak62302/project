        ...
        <div class="row">
            ...
            <div class="col-8">
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <a type="submit" class="btn btn-outline-danger" name="delete" href="delete_Vegetables.php ?id_Vegetable=<?php echo $row['id_Vegetable']; ?>">ลบ</a>
                    <a type="submit" class="btn btn-outline-secondary" name="seve" href="edit_vegetables.php ?id_Vegetable=<?php echo $row['id_Vegetable']; ?>">แก้ไข</a>
                </form>
            </div>
        </div>
