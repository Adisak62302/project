...
<body>
    <div class="container" style="margin-top: 80px;">
        <h3 style="text-align: center;">รายจ่าย</h3>
        <div class="row">
            <div class="col">
                <a href="./Expenses_category.php">
                    <div class="card" style="width: 18rem;">
                        <img src="./img/f4.jpg" class="card-img-top" alt="รูป">
                        <div class="card-body">
                            <h5 class="card-title">หมวดหมู่รายจ่าย</h5>
