...
<body>
    <?php
    $all_expenses  = "SELECT * FROM  category_expenses ";
    $result = mysqli_query($conn, $all_expenses);
    $i = 1;
    ?>

    <body>
        <div class="container">
            <h2>หมวดหมู่รายจ่าย</h2>
            <a type="sumtin" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">เพิ่มหมวดหมู่รายจ่าย</a><br><br>
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">ที่</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $row['Name_category_expenses']; ?></td>
                            <td>
                                <form method="GET">
                                    <a type="sumtin" class="btn btn-outline-danger" name="delete" href="delete_expenses.php ?id=<?php echo $row['id_category_expenses']; ?>">ลบ</a>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="Name_category_expenses" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                </div>
                            </div>
        ...
        if (isset($_POST['seve'])) {
            $Name_category_expenses = $_POST['Name_category_expenses'];
            $sqlInsert = "INSERT INTO category_expenses ( Name_category_expenses, id_user) VALUES ('$Name_category_expenses' , '$user_id')";
            if (mysqli_query($conn, $sqlInsert)) {
                echo "<script>window.location='./Expenses_category.php';</script>";
            } else {
