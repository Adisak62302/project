...
$q = "SELECT * FROM category_expenses ORDER BY Name_category_expenses ASC";
...
<body>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="input-group mb-3">
                                <select requireclass="dropdown-menu dropdown-menu-end" aria-label="Text input with dropdown button" class="form-control"  name="name_expenses">
                                    <option value="">เลือก</option>
                                    <?php foreach ($r as $row) { ?>
                                        <option value="<?php echo $row["Name_category_expenses"]; ?>">
                                            <?php echo $row['Name_category_expenses']; ?>
                                        </option>
                                    <?php } ?>
                                    ?>
                                </select>
    ...
    if (isset($_POST['seve'])) {
        ...
        $name_expenses = $_POST['name_expenses'];
        $price = $_POST['price'];
        $sqlInsert = "INSERT INTO `expenses`(`name_expenses`, `price`, `id_date`)
                                 VALUES ('$name_expenses','$price','$id_date')";
