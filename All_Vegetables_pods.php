...
<?php
$all_veg = "SELECT * FROM  vegetable WHERE (Veg_Type_ID = '4') ";
    ...
    <div class="container mt-3">
        ...
        <div class="row">
            ...
            <?php while ($row = $result->fetch_assoc()) : ?>
                <div class="wrapper col-2">
                    <a type="submit" name="cancel" class="btn" href="infor_Vegetables_pods.php ?id_Vegetable=<?php echo $row['id_Vegetable']; ?>" >
                        <div class="card">
        ...
        if (isset($_POST['seve'])) {
            ...
            if ($rowCheck > 0) {
                ...
                $sqlInsert = "INSERT INTO vegetable (Name, distance, sow_seeds, old, Planing_period, Fertilize, soil, img , Veg_Type_ID, id_user) VALUES ('$name_veg', '$distance', '$sow_seeds', '$old', '$Planing_period', '$Fertilize', '$soil', '$idfilepath' , '4','$user_id')";
